# forte_web3
forte_web3 is a collection of utilities for interacting with Web3 and Ethereum smart contracts.
...
```bash
npm install forte_web3
```
## Usage

const Web3Tools = require('forte_web3');
